...
<form class="form-inline" method="post" action="<%=request.getContextPath() %>/AltaPersona">
	<div class="row">
		<div class="col-xs-3">
			...
			</label> <label for="notas" > Notas: <textarea class="form-control" name="nota" rows="3"></textarea>
			</label>
			<div class="checkbox">
				<label for="esCasado"> <input type="checkbox" name="esCasado" value="Si, esta casado">
					¿Es casado?
				</label>
			</div>
